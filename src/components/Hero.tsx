...
const Hero: React.FC = () => {
  return (
    <section className="pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden bg-gradient-to-br from-blue-50 to-white dark:from-blue-950 dark:to-gray-900">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 md:pr-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-blue-900 dark:text-blue-100 mb-6">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 max-w-md">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">Mejora en conversiones</span>
              </div>
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">Menos tiempo de formación</span>
              </div>
            </div>
          </div>

          <div className="md:w-1/2 relative">
            <div className="relative z-10 bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 md:p-8 max-w-md mx-auto">
